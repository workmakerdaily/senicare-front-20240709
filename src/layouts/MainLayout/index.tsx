...
import { ACCESS_TOKEN, AUTH_ABSOLUTE_PATH, CS_PATH, HR_PATH, MM_PATH, ROOT_ABSOLUTE_PATH, ROOT_PATH } from 'src/constants';
...
function SideNavigation() {
    ...
    return (
        <div id='layout-side-navigation'>SideNavigation</div>
    )
