// variable: 상대 경로 상수 // 
// : 상대 경로 상수는 /옆으로 쌓이는것 예를 들어 AUTH_PATH 다음 CS_PATH 가 되면 /auth/cs
...
export const AUTH_ABSOLUTE_PATH = '/auth';

export const CS_ABSOLUTE_PATH = CS_PATH;
export const CS_WRITE_ABSOLUTE_PATH = `${CS_PATH}/${CS_WRITE_PATH}`;
export const CS_DETAI_ABSOLUTE_PATH = (customNumber: string | number) => `${CS_PATH}/${CS_DETAIL_PATH(customNumber)}`;
...
// variable: HTTP BEARE TOKEN COOKIE NAME //
